...
family_for_basename() {
  case "$1" in
    ...
    fm-agy-harness.test.sh|fm-documentation-audiences.test.sh|fm-ensure-agents-md.test.sh|fm-grok-harness.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    tests/fixtures/*/*)
      ...
      # This nested arm must stay ahead of the wider tests/fixtures/* arm
      # below, which exists for depth-1 fixture files referenced by basename.
